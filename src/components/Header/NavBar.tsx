...
const NavBar = () => {
  ...
  return (
    <nav className="font-roboto-slab">
      <div className="navbar bg-base-200 shadow-sm shadow-[#368BE0] px-6 md:px-10 py-10">
        ...
        <div className="navbar-center hidden  lg:flex ml-auto">
          <div className="menu menu-horizontal px-1 grid md:flex md:flex-row items-center md:justify-center text-lg gap-10">
            {links}
          </div>
        </div>
        ...
        <div className="navbar-end">
          ...
          <div className="lg:hidden">
            <div className="dropdown dropdown-end">
              ...
              <div
                tabIndex={0}
                className="dropdown-content menu bg-base-100 rounded-box z-1 w-fit p-6 shadow-sm font-bold grid gap-4"
              >
                {links}
              </div>
            </div>
